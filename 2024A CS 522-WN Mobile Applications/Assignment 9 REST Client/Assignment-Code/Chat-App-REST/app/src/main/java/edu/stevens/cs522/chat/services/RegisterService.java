...
public class RegisterService extends Service {
    ...
    public int onStartCommand(@NonNull Intent intent, int flags, final int startId) {
        ...
        PendingIntent pendingActionIntent =
                PendingIntent.getService(this, 0, serviceIntent, PendingIntent.FLAG_IMMUTABLE);

        Notification.Action.Builder notificationActionBuilder = new Notification.Action.Builder(icon, getText(R.string.register_cancel_button_label), pendingActionIntent);
        Notification.Action notificationAction = notificationActionBuilder.build();
        ...
        this.startForeground(notificationId, notification, type);

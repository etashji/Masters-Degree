...
public class ChatHelper {
    ...
    public void register (Uri chatServer, String chatName) {
        if (chatName != null && !chatName.isEmpty()) {
            ...
            RegisterService.register(this.context, chatServer, chatName);
        }
    }
    ...
    public void postMessage(String chatRoom, String messageText) {
        if (messageText != null && !messageText.isEmpty()) {
             ...
             */
            OneTimeWorkRequest oneTimeWorkRequest = new OneTimeWorkRequest(PostMessageWorker.class, data);
            workManager.enqueueUniqueWork(oneTimeWorkRequest);
    ...
    public void startMessageSync() {        Log.d(TAG, "Enabling background synchronization of message database.");
        ...
        syncRequest = new PeriodicWorkRequest(SynchronizeWorker.class, new Bundle(), 1);

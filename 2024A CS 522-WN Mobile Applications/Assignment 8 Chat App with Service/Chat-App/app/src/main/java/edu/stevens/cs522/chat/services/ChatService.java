...
public class ChatService extends Service implements IChatService {
    ...
    public void send(String destAddress, String chatRoom, String messageText,
        ...
        bundle.putString("edu.stevens.cs522.chat.services.extra.DEST_ADDRESS", destAddress);
        bundle.putString("edu.stevens.cs522.chat.services.extra.CHATROOM", chatRoom);
        bundle.putString("edu.stevens.cs522.chat.services.extra.MESSAGE_TEXT", messageText);
        bundle.putString("edu.stevens.cs522.chat.services.extra.TIMESTAMP", TimestampConverter.serialize(timestamp));
        bundle.putDouble("edu.stevens.cs522.chat.services.extra.LATITUDE", latitude);
        bundle.putDouble("edu.stevens.cs522.chat.services.extra.LONGITUDE", longitude);
        bundle.putParcelable("edu.stevens.cs522.chat.services.extra.RECEIVER", receiver);

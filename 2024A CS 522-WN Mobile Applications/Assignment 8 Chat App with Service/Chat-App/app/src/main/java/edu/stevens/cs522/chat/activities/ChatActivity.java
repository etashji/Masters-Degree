...
public class ChatActivity extends AppCompatActivity implements ChatroomsFragment.IChatroomListener, MessagesFragment.IChatListener, SendMessage.IMessageSender, ServiceConnection, PostMessageResultReceiver.IReceive {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        sendResultReceiver = new PostMessageResultReceiver(messageHandler, this, this);
    ...
    public void onReceiveResult(int resultCode, Bundle data) {
        switch (resultCode) {
            ...
            default:
                ...
                Toast.makeText(this, R.string.message_fail, Toast.LENGTH_LONG).show();
                break;
        }
    }
        ...
        if (isTwoPane) {
            ...
            callback = new OnBackPressedCallback(true) {
                ...
                public void handleOnBackPressed() {
                    Chatroom chatroom1 = sharedViewModel.getSelected();
                    if (chatroom1 != null && !chatroom1.name.isEmpty()) {
                        chatroom1 = new Chatroom();
                        chatroom1.name = "";
                        sharedViewModel.select(chatroom1);
                    }
                    else {
